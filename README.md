...
## CI/CD
* В процессе разработки, на данный момент добавлены пробные пайплайны прогона сборки/тестирования проектов .NET/Node.JS, 
  а также билда и публикации в GitHub Registry докер-образов
