...
* upd: конкретизированы типы TS (далее: пересмотреть архитектуру типов)
* upd: компоненты React переписаны на функциональные (далее: переписать использование внешнего стейта)
...
* FC: разобраться с внешним стейтом для функциональных компонентов: задействовать Flux/Redux
