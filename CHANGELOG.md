...
* `рефакторинг` `development`
  ...
  * upd: удаление лишних **nullable** в контексте
...
---
  * [x] пробросить токен отмены через функционал
    * [x] отделить клиентский токен от системного: для транзакций, миграций, токенизатора
    * [x] продумать возможность откатов транзакций и завершения миграций при инициализации graceful shutdown
  * [ ] добавить хелсчеки
---
