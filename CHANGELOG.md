...
---
  * [ ] `code-review` оптимизировать **reduced**/**extended** процессоры, используя профилирование:
    * до оптимизации: 50 итераций | ~ время на итерацию: 0.1034 сек | ~ общая память: 5.741 Mb | потребление линейно зависит от количества данных
    * после оптимизации: 50 итераций | ~ время на итерацию: ...... сек | ~ общая память: ..... Mb | потребление .....
  * [x] добавить обёртку над токенами и векторами в токенизаторе.
