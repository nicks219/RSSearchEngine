...
* `develop/release/6.0.0-pre-2` `рефакторинг` `пре-релиз` `beta`
  ...
  * `k6.0.0` `d0.0.1` upd: рассмотреть возможность заменить в Rsse.Data конкретные зависимости на абстрактные
---
  * [ ] закрыть параметры ручек проверкой required и разобраться с основными кодами ответов сервиса
  * [ ] добавить хелсчеки: трафик можно принимать после завершения инициализации
---
