...
* 5.2.6
  ...
  * observability: добавлены метрики и рейтлимитер на техническую ручку
...
* 5.2.x upd: добавлены и протестированы k3s-конфиги traefik для доступа по ip и https-доступа с адреса notefinder.ru
...
* **UI**:
  ...
  * вынести системный функционал в отдельную админку
