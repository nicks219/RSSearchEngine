...
* upd: компоненты клиента переписаны на функциональные (далее: переписать использование внешнего стейта)
...
* React: задействовать Flux/Redux для работы со стейтом 
