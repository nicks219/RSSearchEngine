...
* `develop/release/6.0.0-pre-2` `рефакторинг` `пре-релиз` `beta`
  * [сравнение ветки 6.0.0-pre-2 с последним релизом k0.0.1 в github](https://github.com/nicks219/RSSearchEngine/compare/k0.0.1...6.0.0-pre-release-2)
...
---
* `develop`
  * [x] добавить манифест для экспорта метрик **otel** - **graphana**, также см [kubectl create secret](.common/scripts.k3s.bash)
  * [x] добавить хелсчеки (трафик можно принимать при завершения инициализации)
  * [x] выделить тесты на реальных бд в отдельный проект
  * [x] заменить EnsureCreated при инициализации на SQL
  * [ ] закрыть параметры ручек проверкой required и разобраться с основными кодами ответов сервиса
