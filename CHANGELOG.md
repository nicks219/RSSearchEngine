...
* 5.2.1 upd: конкретизированы типы TS (далее: пересмотреть архитектуру типов)
* 5.2.1 upd: компоненты клиента переписаны на функциональные (далее: доработать использование внешнего стейта)
* 5.2.2 upd: уменьшено количество полей в глобальном стейте
...
* React: упростить контейнер со стейтом, задействовать Flux/Redux
