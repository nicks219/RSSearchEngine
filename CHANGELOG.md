...
---
  * [x] корректная отмена миграций
  * [x] задействовать NpgSqlDataSource и MySqlDataSource
  * [x] рассмотреть возможность заменить в Rsse.Data конкретные зависимости на абстрактные
