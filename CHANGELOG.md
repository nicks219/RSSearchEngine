...
* fix: конкретизированы типы TS (архитектура типов нуждается в пересмотре)
* fix: компоненты React переписаны на функциональные (архитектура использования внешнего стейта требует пересмотра)
...
* FC: разобраться со статическим стейтом для функциональных компонентов (прикрутить Flux/Redux)
