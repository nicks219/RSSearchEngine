...
* в разработке: адаптивный дизайн mobile/desktop | grid-вёрстка
  * контроллер update целиком убран под авторизацию
  * при перезагрузке страницы авторизация проверяется на сервере и кэшируется в local storage
