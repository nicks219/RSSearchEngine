...
---
  * [ ] `docker-compose` поставлять observability в OTLP формате на http://otel-collector:4317
    ...
    * [x] отключить на тестах регистрацию трейсов, метрик и ручки `/metrics`
    * [x] флаги: добавить `EnableTelemetry` и поменять логику `TRACING_ENABLE`
    * [ ] убрать AddConsoleExporter для трейсов и его зависимости из проекта
