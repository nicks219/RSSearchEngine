...
* ci: проект esproj переправлен в csproj тк увеличилось время билда .NET по сравнению с v5.0.0 
      из-за ошибок в Microsoft.VisualStudio.JavaScript.Sdk (билдило фронт на CI)
