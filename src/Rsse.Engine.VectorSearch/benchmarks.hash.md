...
|---------------------------- |------------------- |------------------- |--------------:|-----------:|-----------:|--------------:|-------------:|
| DuplicatesBenchmarkExtended | DuplicatesExtended | GinSimpleFilter    |    71.4985 ms |  1.1053 ms |  0.7311 ms |    70.4870 ms |  43208.91 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended | GinOptimizedFilter |   285.6757 ms |  3.6994 ms |  2.2014 ms |   282.5283 ms |  44179.80 KB |
...
| DuplicatesBenchmarkExtended | DuplicatesExtended | GinFastFilter      | 1,372.7167 ms |  6.6229 ms |  4.3807 ms | 1,365.6579 ms | 589826.16 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended | GinFast            | 2,076.5755 ms |  6.0991 ms |  3.1899 ms | 2,070.5198 ms | 548678.03 KB |
|                             |                    |                    |               |            |            |               |              |
| QueryBenchmarkExtended      | QueryExtended      | GinOptimizedFilter |     0.1087 ms |  0.0005 ms |  0.0003 ms |     0.1083 ms |     25.90 KB |
| QueryBenchmarkExtended      | QueryExtended      | GinFastFilter      |     0.2620 ms |  0.0112 ms |  0.0074 ms |     0.2562 ms |    283.69 KB |
| QueryBenchmarkExtended      | QueryExtended      | GinSimpleFilter    |     0.6934 ms |  0.0146 ms |  0.0096 ms |     0.6709 ms |     13.31 KB |
| QueryBenchmarkExtended      | QueryExtended      | GinFast            |     1.2429 ms |  0.0390 ms |  0.0258 ms |     1.1998 ms |    270.70 KB |
| QueryBenchmarkExtended      | QueryExtended      | GinOptimized       |     1.6833 ms |  0.0399 ms |  0.0264 ms |     1.6249 ms |    252.45 KB |
...
|                             |                    |                    |               |            |            |               |              |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  | GinFast            |   113.7162 ms |  1.1770 ms |  0.7785 ms |   112.4263 ms |  70059.50 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  | GinOptimized       |   173.2782 ms |  2.5735 ms |  1.5314 ms |   171.3618 ms |  70059.62 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  | GinFastFilter      |   206.7772 ms |  2.0917 ms |  1.3835 ms |   204.8027 ms |  44478.61 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  | GinOptimizedFilter |   228.0318 ms |  2.3524 ms |  1.2303 ms |   225.9259 ms |  44478.62 KB |
...
|                             |                    |                    |               |            |            |               |              |
| QueryBenchmarkReduced       | QueryReduced       | GinFastFilter      |     0.6830 ms |  0.0089 ms |  0.0053 ms |     0.6699 ms |    578.15 KB |
| QueryBenchmarkReduced       | QueryReduced       | GinOptimizedFilter |     0.7108 ms |  0.0056 ms |  0.0033 ms |     0.7054 ms |    578.15 KB |
| QueryBenchmarkReduced       | QueryReduced       | GinFast            |     0.8674 ms |  0.0154 ms |  0.0092 ms |     0.8546 ms |    667.75 KB |
| QueryBenchmarkReduced       | QueryReduced       | GinOptimized       |     0.9139 ms |  0.0144 ms |  0.0095 ms |     0.9014 ms |    667.76 KB |
| QueryBenchmarkReduced       | QueryReduced       | GinSimpleFilter    |     1.6575 ms |  0.0119 ms |  0.0071 ms |     1.6487 ms |    263.13 KB |
...
| Type                        | Method             | SearchType              | Mean          | Error      | StdDev     | Min           | Allocated    |
|---------------------------- |------------------- |------------------------ |--------------:|-----------:|-----------:|--------------:|-------------:|
| DuplicatesBenchmarkExtended | DuplicatesExtended |      GinFilter          |    58.0136 ms |  0.6641 ms |  0.3473 ms |    57.5496 ms |  43150.90 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended | Pool GinFastFilter      |   210.9734 ms |  2.2526 ms |  1.4899 ms |   208.9451 ms |  89389.42 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended |      GinFastFilter      |   223.9624 ms |  3.5025 ms |  2.3167 ms |   220.9855 ms | 141872.45 KB |
...
| DuplicatesBenchmarkExtended | DuplicatesExtended |      GinFast            |   974.6816 ms |  4.5483 ms |  2.3789 ms |   969.2262 ms | 100724.18 KB |
|                             |                    |                         |               |            |            |               |              |
| QueryBenchmarkExtended      | QueryExtended      |      GinFilter          |     0.0291 ms |  0.0003 ms |  0.0001 ms |     0.0289 ms |     13.25 KB |
| QueryBenchmarkExtended      | QueryExtended      | Pool GinFastFilter      |     0.3662 ms |  0.0075 ms |  0.0050 ms |     0.3580 ms |    398.87 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinFastFilter      |     0.4574 ms |  0.0066 ms |  0.0044 ms |     0.4519 ms |    651.08 KB |
| QueryBenchmarkExtended      | QueryExtended      | Pool GinFast            |     1.3596 ms |  0.0294 ms |  0.0194 ms |     1.3224 ms |    385.86 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinFast            |     1.4354 ms |  0.0567 ms |  0.0337 ms |     1.3794 ms |    638.07 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinOptimized       |     1.6600 ms |  0.0126 ms |  0.0066 ms |     1.6460 ms |    252.45 KB |
...
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinOptimized       |   106.4066 ms |  2.3346 ms |  1.5442 ms |   104.7496 ms |  70059.50 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFast            |   111.4918 ms |  1.9308 ms |  1.1490 ms |   110.2242 ms |  72674.81 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinOptimizedFilter |   114.7251 ms |  1.2970 ms |  0.6783 ms |   113.5562 ms |  35538.01 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  | Pool GinFastFilter      |   126.7914 ms |  2.8487 ms |  1.6952 ms |   124.6739 ms |  36648.05 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFastFilter      |   135.2468 ms |  2.3841 ms |  1.5769 ms |   133.4772 ms |  47845.91 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFilter          |   238.2699 ms |  2.5054 ms |  1.6572 ms |   235.9145 ms |  33280.12 KB |
...
| QueryBenchmarkReduced       | QueryReduced       |      GinFast            |     0.2799 ms |  0.0087 ms |  0.0057 ms |     0.2699 ms |    326.03 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinOptimizedFilter |     0.2818 ms |  0.0059 ms |  0.0039 ms |     0.2772 ms |    326.04 KB |
| QueryBenchmarkReduced       | QueryReduced       | Pool GinFastFilter      |     0.3282 ms |  0.0100 ms |  0.0066 ms |     0.3203 ms |    263.58 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinFastFilter      |     0.4838 ms |  0.0203 ms |  0.0134 ms |     0.4618 ms |    578.65 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinOptimized       |     0.8817 ms |  0.0255 ms |  0.0169 ms |     0.8619 ms |    667.75 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinFilter          |     1.2452 ms |  0.0285 ms |  0.0188 ms |     1.2126 ms |    263.07 KB |
...
| Type                        | Method             | SearchType              | Mean          | Error      | StdDev    | Min           | Allocated   |
|---------------------------- |------------------- |------------------------ |--------------:|-----------:|----------:|--------------:|------------:|
| DuplicatesBenchmarkExtended | DuplicatesExtended | Pool GinFilter          |    52.3181 ms |  1.0682 ms | 0.7065 ms |    51.4560 ms | 24321.98 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended |      GinFilter          |    53.0141 ms |  0.8931 ms | 0.5907 ms |    52.1514 ms | 28199.95 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended | Pool GinFastFilter      |    54.0969 ms |  1.2129 ms | 0.7218 ms |    53.4739 ms | 24322.02 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended |      GinFastFilter      |    55.5764 ms |  0.7482 ms | 0.4452 ms |    54.7822 ms | 29353.09 KB |
...
| QueryBenchmarkExtended      | QueryExtended      |      GinFilter          |     0.0287 ms |  0.0004 ms | 0.0002 ms |     0.0283 ms |    13.50 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinFastFilter      |     0.0342 ms |  0.0005 ms | 0.0003 ms |     0.0338 ms |    26.31 KB |
| QueryBenchmarkExtended      | QueryExtended      | Pool GinFast            |     1.2423 ms |  0.0583 ms | 0.0386 ms |     1.1712 ms |     0.24 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinFast            |     1.3509 ms |  0.0561 ms | 0.0371 ms |     1.2807 ms |   252.62 KB |
| QueryBenchmarkExtended      | QueryExtended      | Pool GinOptimized       |     1.5984 ms |  0.0441 ms | 0.0292 ms |     1.5455 ms |     0.24 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinOptimized       |     1.6579 ms |  0.0580 ms | 0.0383 ms |     1.5984 ms |   252.62 KB |
...
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinOptimized       |   106.8661 ms |  3.0085 ms | 1.9899 ms |   104.6667 ms | 70059.60 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFast            |   111.7446 ms |  3.1447 ms | 2.0800 ms |   109.3015 ms | 72674.32 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinOptimizedFilter |   113.0141 ms |  0.9451 ms | 0.5624 ms |   112.1732 ms | 35537.95 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  | Pool GinFastFilter      |   126.2593 ms |  1.6596 ms | 1.0978 ms |   124.8837 ms | 36647.80 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFastFilter      |   136.2970 ms |  6.7367 ms | 4.4559 ms |   132.7280 ms | 47846.29 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFilter          |   234.7708 ms |  1.5049 ms | 0.8956 ms |   233.3047 ms | 33280.22 KB |
...
| QueryBenchmarkReduced       | QueryReduced       |      GinFast            |     0.2696 ms |  0.0058 ms | 0.0039 ms |     0.2628 ms |   326.04 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinOptimizedFilter |     0.2919 ms |  0.0059 ms | 0.0039 ms |     0.2839 ms |   326.04 KB |
| QueryBenchmarkReduced       | QueryReduced       | Pool GinFastFilter      |     0.3267 ms |  0.0082 ms | 0.0054 ms |     0.3189 ms |   263.58 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinFastFilter      |     0.4892 ms |  0.0126 ms | 0.0083 ms |     0.4746 ms |   578.66 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinOptimized       |     0.9022 ms |  0.0273 ms | 0.0180 ms |     0.8763 ms |   667.76 KB |
...
| DuplicatesBenchmarkExtended | DuplicatesExtended |      GinFilter          |    53.9538 ms |  1.4292 ms | 0.9453 ms |    52.7247 ms |  8915.78 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended | Pool GinFastFilter      |    55.9458 ms |  1.7184 ms | 1.1366 ms |    54.9254 ms |  2060.69 KB |
| DuplicatesBenchmarkExtended | DuplicatesExtended |      GinFastFilter      |    57.5734 ms |  1.5186 ms | 1.0045 ms |    56.4048 ms | 10181.20 KB |
...
| QueryBenchmarkExtended      | QueryExtended      |      GinFilter          |     0.0295 ms |  0.0003 ms | 0.0002 ms |     0.0291 ms |    13.13 KB |
| QueryBenchmarkExtended      | QueryExtended      | Pool GinFastFilter      |     0.0305 ms |  0.0005 ms | 0.0003 ms |     0.0301 ms |     0.30 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinFastFilter      |     0.0359 ms |  0.0003 ms | 0.0002 ms |     0.0356 ms |    25.94 KB |
| QueryBenchmarkExtended      | QueryExtended      | Pool GinFast            |     1.2477 ms |  0.0574 ms | 0.0379 ms |     1.1951 ms |     0.24 KB |
| QueryBenchmarkExtended      | QueryExtended      |      GinFast            |     1.3495 ms |  0.0632 ms | 0.0418 ms |     1.2761 ms |   252.62 KB |
...
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinOptimized       |   112.5586 ms |  3.1867 ms | 1.8963 ms |   110.0847 ms | 70059.81 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinOptimizedFilter |   117.8411 ms |  1.3967 ms | 0.8312 ms |   116.6529 ms | 17172.22 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFast            |   121.5838 ms |  1.6906 ms | 1.0061 ms |   119.9293 ms | 70864.50 KB |
| DuplicatesBenchmarkReduced  | DuplicatesReduced  |      GinFastFilter      |   122.7481 ms |  1.8336 ms | 1.0911 ms |   121.5755 ms | 26163.05 KB |
...
| QueryBenchmarkReduced       | QueryReduced       |      GinFast            |     0.3071 ms |  0.0064 ms | 0.0042 ms |     0.2991 ms |   325.61 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinOptimizedFilter |     0.3201 ms |  0.0048 ms | 0.0032 ms |     0.3158 ms |   325.61 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinFastFilter      |     0.3780 ms |  0.0042 ms | 0.0025 ms |     0.3735 ms |   446.23 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinOptimized       |     0.5486 ms |  0.0108 ms | 0.0071 ms |     0.5374 ms |   667.75 KB |
| QueryBenchmarkReduced       | QueryReduced       | Pool GinFilter          |     1.1900 ms |  0.0348 ms | 0.0230 ms |     1.1617 ms |    10.45 KB |
| QueryBenchmarkReduced       | QueryReduced       |      GinFilter          |     1.2975 ms |  0.0593 ms | 0.0392 ms |     1.2190 ms |   325.62 KB |
