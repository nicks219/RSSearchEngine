...
public readonly struct OffsetInfo(int size, int offsetIndex)
{
    ...
    {
        // ќптимизируем хранение позиций токенов - если позиций больще двух то храним в Offsets,
        // иначе храним позиции в OffsetInfos - первую позицию в Size вторую позицию OffsetIndex.
        // ѕозиции в OffsetInfos храним как отрицательные,
        // если Size отрицательный или ноль - то это перва€ позици€,
        // если OffsetIndex отрицательный - то это втора€ позици€,
        // если Size больще нол€ - позиции хран€тс€ в Offsets.
    ...
    /// <summary>
    /// ќптимизаци€ хранени€ позиций описана в <see cref="OffsetInfo.CreateOffsetInfo"/>
    /// </summary>
