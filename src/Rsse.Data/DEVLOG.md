...
---
* добавить тесты:
  * корректно изолировать контексты с разными строками подключения Sqlite не получится, 
    тесты следует выполнять на реальных инстансах, тем более проверяется специфичный для postgres кейс
  ...
  * после создания/восстановления дампа: проверить те же кейсы 
  * ... 
---
