...
/// </summary>
public class ExtendedMetricsOriginal : ExtendedMetricsBase, IExtendedMetricsProcessor
{
    /// <inheritdoc/>
    public bool FindExtended(string text, Dictionary<DocId, double> complianceMetrics, CancellationToken cancellationToken)
    {
        ...
        if (cancellationToken.IsCancellationRequested) throw new OperationCanceledException(nameof(ExtendedMetricsOriginal));
