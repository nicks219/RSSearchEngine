...
/// </summary>
public sealed class ReducedSearchGinOptimized : ReducedSearchProcessorBase, IReducedSearchProcessor
{
    /// <summary>
    ...
    public void FindReduced(string text, MetricsCalculator metricsCalculator, CancellationToken cancellationToken)
    {
        ...
        {
            if (!InvertedIndexReduced.TryGetIdentifiers(token, out var ids))
            {
                continue;
            }
        ...
        {
            var reducedTargetVector = directIndex[docId].Reduced;
