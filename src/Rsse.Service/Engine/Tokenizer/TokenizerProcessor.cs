...
public sealed class TokenizerProcessor : ITokenizerProcessor
{
    ...
    /// <summary>
    /// Вычислить метрику сравнения двух векторов, для эталонного урезанного набора
    /// </summary>
    ...
    /// <summary>
    /// Вычислить метрику сравнения двух векторов, для эталонного расширенного набора.
    /// Учитывается совпадение последовательности токенов (т.е. "слов")
    /// </summary>
    /// <param name="referenceTokens">эталонный вектор</param>
    /// <param name="inputTokens">сравниваемый вектор</param>
    /// <returns>метрика количества совпадений</returns>
